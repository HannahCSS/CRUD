<?php
require "../common.php"; // Include common functions 
require_once '../src/DBconnect.php'; // database connection
...
if (isset($_GET['id'])) {
    ...
    try {
        //  Fetch user data for pre-filling the update form
        ...
        // If no user is found, display an error and exit
        if (!$user) {
            echo "❌ User not found!";
            exit;
        }
